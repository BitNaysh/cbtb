#  python3  final.py --cfg experiments/300w/face_alignment_300w_hrnet_w18.yaml --landmark_model HR18-300W.pth --mask_image masks/anti_covid.png --input_image_path input_folder/download.jpg
...
def main():
    ...
    # parser.add_argument('output_folder', type=str, help='Path to save the output image')
    args = parser.parse_args()
    ...
    while True:
        ...
        output_path = os.path.join(output_folder, f"masked_1.jpg")
